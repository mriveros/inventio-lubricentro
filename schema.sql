/*
* Modelo de base de datos del sistema Inventio Hub version 8
* @author smarthub
* @url http://www.smarthub.com.py
*/
...
insert into configuration(short,name,kind,val) value("company_name","Nombre de la empresa",2,"Powered by Inventio Hub");
insert into configuration(short,name,kind,val) value("title","Titulo del Sistema",2,"Inventio Hub 1.0");
insert into configuration(short,name,kind,val) value("ticket_title","Titulo en el Ticket",2,"INVENTIO HUB v1.0");
...
insert into configuration(short,name,kind,val) value("imp-val","Valor Impuesto (%)",2,"10");
insert into configuration(short,name,kind,val) value("currency","Simbolo de Moneda",2,"Gs");
