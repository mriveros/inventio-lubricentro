...
<div class="row">
  ...
  <table class="table">
  <tr><td>
		<form autocomplete="off" class="form-horizontal" method="post" id="addcategory" action="index.php?action=categories&opt=add" role="form">
...
<div class="row">
  ...
  <table class="table">
  <tr><td>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?action=categories&opt=upd" role="form">
