...
if($user->kind=="1"){ $kind = "Administrador"; }
else if($user->kind=="2"){ $kind = "Almacenista"; }
else if($user->kind=="3"){ $kind = "Vendedor"; }
else if($user->kind=="4"){ $kind = "Administrador de Sucursal"; }
?>
<div class="row">
	<div class="col-md-12">
	<h1>Editar Usuario <small><?php echo $kind; ?></small></h1>
	<br>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?view=updateuser" role="form">
