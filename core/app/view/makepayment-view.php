...
<div class="row">
  ...
  <tr>
  <td>
		<form autocomplete="off" class="form-horizontal" method="post" enctype="multipart/form-data" id="addpayment<?php echo $ca['sell_id']; ?>" action="index.php?action=addpayment" role="form">
