...
for($i=$sd;$i<=$ed;$i+=(60*60*24)){
  ...
  $payments = PaymentData::sumAllByDate(date("Y-m-d",$i),date("Y-m-d",$i));
...
<?php // foreach($operations as $operation):?>
	<tr>
		...
		<td><?php echo Core::$symbol; ?> <?php echo number_format($payments->t,2,'.',','); ?></td>
...
<div class="jumbotron">
	...
	<tr>
		...
		<td><?php echo Core::$symbol; ?> <?php echo number_format($paymentstotal,2,'.',','); ?></td>
		<td><?php echo Core::$symbol; ?> <?php echo number_format($spendtotal,2,'.',','); ?></td>
		<td><?php echo Core::$symbol; ?> <?php echo number_format(($selltotal+$paymentstotal)-($spendtotal+$restotal),2,'.',','); ?></td>
	</tr>
</table>
</div>
<?php else:?>
