...
<div class="row">
	<div class="col-md-12">
	<h1>Reportes de Clientes Populares</h1>
...
<div class="col-md-3">
<input type="date" name="sd" value="<?php if(isset($_GET["sd"])){ echo $_GET["sd"]; }else{echo date('Y-m-d',(time() -(60*60*24*30) ));}?>" class="form-control">
</div>
<div class="col-md-3">
...
var rows = [
  ...
  ?>
    {
      "id": "<?php echo $operation->person_id; ?>",
