...
<form autocomplete="off" method="post" class="form-horizontal" id="processcotization" action="index.php?action=processcotization">
...
$clients = PersonData::getClients();
    ...
    <?php foreach($clients as $client):?>
    	<option value="<?php echo $client->id;?>" <?php if($sell->person_id==$client->id){ echo "selected"; }?>><?php echo $client->name." ".$client->lastname;?></option>
    <?php endforeach;?>
    	</select>
    </div>
  </div>
