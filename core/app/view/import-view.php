...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    ...
    <form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?action=import" enctype="multipart/form-data" role="form">
...
<pre>
RAEA050892,Agustin,Ramos Escalante,Tabasco , smarthub@gmail.com, +52 1 914 1183199
