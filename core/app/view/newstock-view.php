...
<div class="row">
  ...
  <table class="table">
  <tr><td>
		<form autocomplete="off" class="form-horizontal" method="post" id="addcategory" action="index.php?action=addstock" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="address"  class="form-control" id="name" placeholder="Dirección" required>
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="field1"  class="form-control" id="name" placeholder="Campo 1">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Campo 2</label>
    <div class="col-md-6">
      <input type="text" name="field2"  class="form-control" id="name" placeholder="Campo 2">
    </div>
  </div>
  <div class="form-group">
