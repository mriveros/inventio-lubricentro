...
<div class="row">
	...
	<h1>Reporte de Inventario</h1>
						...
						<input type="hidden" name="view" value="inventorylog">
<div class="row">
<div class="col-md-2">
...
<select name="stock_id" required class="form-control">
	...
	<?php endforeach; ?>
	<?php else:
$stock = StockData::getById(Core::$user->stock_id);
		?>
	<option value="<?php echo Core::$user->stock_id;?>" <?php if(isset($_GET["stock_id"]) && $_GET["stock_id"]==Core::$user->stock_id){ echo "selected"; }?>><?php echo $stock->name;?></option>
	<?php endif;?>
</select>
