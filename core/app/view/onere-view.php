...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="ticket-re.php?id=<?php echo $_GET["id"];?>" target="_blank">Ticket (.pdf)</a></li>
...
<div class="col-md-4">
<form autocomplete="off" method="post" class="form-horizontal" action="./?action=updatere" id="processsell" enctype="multipart/form-data">
<div class="row">
<div class="col-md-12">
<div>
...
var doc = new jsPDF('p', 'pt');
        doc.setFontSize(26);
        doc.text("NOTA DE ABASTECIMIENTO #<?php echo $sell->id; ?>", 40, 65);
        doc.setFontSize(14);
