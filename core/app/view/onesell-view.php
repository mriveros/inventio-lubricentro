...
<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="ticket.php?id=<?php echo $_GET["id"];?>" target="_blank">Ticket (.pdf)</a></li>
...
$iva_calc = $sell->total/(1+($iva_val/100)) * ($iva_val/100);
  ?>
<table class="table table-bordered">
  <tr>
    <td><h4>Subtotal:</h4></td>
    <td><h4><?php echo $symbol; ?> <?php echo number_format($total-$iva_calc,2,'.',','); ?></h4></td>
  </tr>
  ...
  <tr>
    <td><h4>Subtotal:</h4></td>
    <td><h4><?php echo $symbol; ?> <?php echo number_format($total-$iva_calc-$sell->discount,2,'.',','); ?></h4></td>
  </tr>
  <tr>
    <td><h4>Impuesto:</h4></td>
    <td><h4><?php echo $symbol; ?> <?php echo number_format( $iva_calc,2,'.',','); ?></h4></td>
  </tr>
  <tr>  <tr>
    <td><h4>Total:</h4></td>
    <td><h4><?php echo $symbol; ?> <?php echo number_format($total-  $sell->discount,2,'.',','); ?></h4></td>
...
<div class="col-md-4">
<form autocomplete="off" method="post" class="form-horizontal" action="./?action=updatesell" id="processsell" enctype="multipart/form-data">
<div class="row">
<div class="col-md-12">
<div>
...
var rows3 = [
    ...
    {
      "clave": "Subtotal",
      "valor": "<?php echo Core::$symbol;?> <?php echo number_format($sell->total-$iva_calc+$sell->discount,2,'.',',');; ?>",
      },
    ...
    {
      "clave": "Subtotal",
      "valor": "<?php echo Core::$symbol;?> <?php echo number_format($sell->total-$iva_calc,2,'.',',');; ?>",
      },
    {
      "clave": "Impuesto",
      "valor": "<?php echo Core::$symbol;?> <?php echo number_format($sell->total/(1+($iva_val/100)) * ($iva_val/100),2,'.',',');; ?>",
...
var doc = new jsPDF('p', 'pt');
        doc.setFontSize(26);
        doc.text("NOTA DE VENTA #<?php echo $sell->id; ?>", 40, 65);
        doc.setFontSize(14);
...
//        doc.text("Factura #<?php echo $sell->id; ?>", 40, 65);
        doc.setFontSize(11);
