...
<div class="row">
  ...
  <table class="table">
  <tr><td>
		<form autocomplete="off" class="form-horizontal" method="post" id="addcategory" action="index.php?action=brands&opt=add" role="form">
...
<div class="row">
  ...
  <table class="table">
  <tr><td>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?action=brands&opt=upd" role="form">
