...
if(isset($_GET["stock"])){ $selstock=$_GET["stock"]; }
  ...
  <a href="index.php?view=alerts&stock=<?php echo $s->id; ?>" class="btn btn-default"><?php echo $s->name; ?></a>
<?php endforeach; ?>
<?php if($found):?>
<div class="btn-group">
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="report/alerts-word.php?stock=<?php echo $selstock; ?>">Word 2007 (.docx)</a></li>
    <li><a href="report/alerts-xlsx.php?stock=<?php echo $selstock; ?>">Excel 2007 (.xlsx)</a></li>
