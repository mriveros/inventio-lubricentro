...
<div class="row">
	...
	<br>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?view=updateclient" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="no" value="<?php echo $user->no;?>" class="form-control" id="no" placeholder="RUC/CI">
    </div>
  </div>
...
<div class="checkbox">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Crédito</label>
    <div class="col-md-6">
