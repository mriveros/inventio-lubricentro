...
else if($_GET["kind"]=="4"){ $kind = "Administrador de Sucursal"; }
?>
<section class="content">
<div class="row">
	<div class="col-md-12">
	<h1>Agregar Usuario <small><?php echo $kind; ?></small></h1>
	<br>
		<form autocomplete="off" class="form-horizontal" enctype="multipart/form-data"  method="post" id="addproduct" action="index.php?view=adduser" role="form">
