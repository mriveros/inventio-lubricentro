...
$q= OperationData::getQByStock($product->id,$_SESSION["stock_id"]);
	...
	?>
		<form autocomplete="off" method="post" action="index.php?view=addtotraspase">
...
<form autocomplete="off" method="post" class="form-horizontal" id="processsell" action="index.php?view=processtraspase">
<h2>Resumen</h2>
