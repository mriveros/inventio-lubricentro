...
<div class="box box-primary">
  ...
  <tr>
  <td>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?view=updateproduct" role="form">
...
<?php endif;?>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="presentation" class="form-control" id="inputEmail1" value="<?php echo $product->presentation; ?>" placeholder="Presentación del Producto">
    </div>
  </div>
  <div class="form-group">
