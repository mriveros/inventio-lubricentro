...
<div class="box box-primary"><br>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?view=addclient" role="form">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label" >Activar Crédito</label>
    <div class="col-md-6">
<div class="checkbox">
    <label>
