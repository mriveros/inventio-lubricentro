...
<div class="row">
	...
	<br>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?view=updateprovider" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
      <input type="text" name="phone1"  value="<?php echo $user->phone1;?>"  class="form-control" id="inputEmail1" placeholder="Teléfono">
    </div>
  </div>
