...
<div class="row">
	...
	<br>
		<form autocomplete="off" class="form-horizontal" method="post" id="addproduct" action="index.php?action=updatedeposit" role="form">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="user_id" value="<?php echo $user->id;?>">
      <button type="submit" class="btn btn-primary">Actualizar Deposito</button>
    </div>
  </div>
</form>
	</div>
