...
if($product->kind==1){
  ...
  ?>
		...
		<form autocomplete="off" method="post" action="index.php?view=addtocart" id="addtocart<?php echo $product->id;?>">
			<select class="form-control" name="price">
				<!-- <option value="">- PRECIO -</option> -->
				<option value="<?php echo $product->price_out; ?>">Gs. <?php echo $product->price_out; ?></option>
				<option value="<?php echo $product->price_out2; ?>">Gs. <?php echo $product->price_out2; ?></option>
				<option value="<?php echo $product->price_out3; ?>">Gs. <?php echo $product->price_out3; ?></option>
			</select>
