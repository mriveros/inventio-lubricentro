...
<form autocomplete="off" class="form-horizontal" method="post" id="addclient" action="index.php?view=addclient" role="form">
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <input type="text" name="no" class="form-control" id="no" placeholder="RUC">
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label" >Activar Crédito</label>
    <div class="col-md-8">
<div class="checkbox">
    <label>
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Limite de crédito</label>
    <div class="col-md-8">
      <input type="text" name="credit_limit" class="form-control" id="" placeholder="Limite de crédito">
    </div>
  </div>
...
<p class="text-muted">Acceso en (http://localhost/inventio/?view=clientaccess) con Email, Password y Acceso Activado</p>
    </div>
    </div>
...
<form autocomplete="off" method="post" class="form-horizontal" id="processsell" enctype="multipart/form-data">
<h2>Resumen</h2>
...
if(lim[client]>=cur[client]+(<?php echo $total; ?>-discount)){
          $.post("./index.php?action=processsell",$("#processsell").serialize(),function(data){
            ...
            alert("El cliente ha alcanzado el límite de crédito, no se puede procesar la venta!");

}
        }else{
          // el cliente no tiene credito
          alert("El cliente seleccionado no cuenta con crédito!");
          e.preventDefault();
