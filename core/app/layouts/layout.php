...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Inventio Hub| Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg">INVENTIO<b>HUB</b></span>
        </a>
...
<?php endif;?>
              ...
              <li class="dropdown user user-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  else if(Core::$user->kind==4){ echo " (Admin. de Sucursal)"; }
...
<?php if(Core::$user->kind==1||Core::$user->kind==3||Core::$user->kind==4):?>
            <li><a href="./?view=sellnew"><i class='fa fa-star'></i> <span>Vender</span></a></li>
<?php endif; ?>
...
<?php if(Core::$user->kind==1||Core::$user->kind==4):?>
    ...
    <?php endif;?>
      ...
      <div class="content-wrapper">
        ...
        <strong>Copyright &copy; 2020 <a href="http://smarthub.com/company/" target="_blank">smarthub</a></strong>
      </footer>
      <?php else:?>
        <?php if(isset($_GET["view"]) && $_GET["view"]=="clientaccess"):?>
<div class="login-box">
      <div class="login-logo">
        <a href="./">INVENTIO<b>HUB</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
      <center><h4>Cliente</h4></center>
        <form autocomplete="off" action="./?action=processloginclient" method="post">
...
<div class="login-box" >
      ...
      <center><h4>Admin</h4></center>
        <form autocomplete="off" action="./?action=processlogin" method="post">
          <div class="form-group has-feedback">
            <input type="text" name="username" required class="form-control" placeholder="Usuario"/>
            <span class="glyphicon glyphicon-user form-control-feedback"></span>
          </div>
