...
$section1->addText("RESUMEN DE DEVOLUCION",array("size"=>22,"bold"=>true,"align"=>"right"));
...
$section1->addText("");
$section1->addText("SubTotal: $symbol ".number_format(($total)/(1 + ($iva_val/100) ),2,".",","),array("size"=>20));
$section1->addText("Impuesto: $symbol ".number_format( ($total/(1 + ($iva_val/100) )) *($iva_val/100),2,'.',','),array("size"=>20));
$section1->addText("Descuento: $symbol ".number_format($sell->discount,2,".",","),array("size"=>20));
$section1->addText("SubTotal: $symbol ".number_format($total,2,".",","),array("size"=>20));
$section1->addText("Total: $symbol ".number_format($total-$sell->discount,2,".",","),array("size"=>20));
