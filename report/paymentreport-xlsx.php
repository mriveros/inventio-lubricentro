...
$objPHPExcel->getProperties()->setCreator("Inventio Hub v4.1")
							 ->setLastModifiedBy("Inventio Hub v4.1")
							 ->setTitle("Inventio Hub v4.1")
							 ->setSubject("Inventio Hub v4.1")
							 ->setDescription("")
							 ->setKeywords("")
							 ->setCategory("");
...
$sheet->setCellValue('A1', 'Reporte de Pagos - Inventio Hub')
